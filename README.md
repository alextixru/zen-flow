...
<p align="center">
   Открытая альтернатива Zapier с исходным кодом
</p>
...
# 🤯 Добро пожаловать в Activepieces

Комплексная платформа AI-автоматизации, спроектированная как **расширяемая** благодаря **типобезопасному** фреймворку pieces, написанному на **TypeScript**.
Когда вы добавляете pieces в Activepieces, они автоматически становятся доступны как MCP-серверы, которые можно использовать с LLM через Claude Desktop, Cursor или Windsurf!

<br>
<br>

## 🔥 Чем Activepieces отличается:

- **💖 Нравится всем**: Интуитивно понятный интерфейс и отличный опыт как для технических, так и для нетехнических пользователей с быстрым порогом входа.

<img src="/docs/resources/templates.gif">

- **🌐 Открытая экосистема:** Все pieces имеют открытый исходный код и доступны на npmjs.com, **60% pieces созданы сообществом**.

- **🛠️ Крупнейший open source MCP-тулкит**: Все наши pieces (280+) доступны как MCP, который можно использовать с LLM в Claude Desktop, Cursor или Windsurf.

- **🛠️  Pieces написаны на TypeScript**: Pieces — это npm-пакеты на TypeScript, дающие полную кастомизацию и лучший опыт разработки, включая **горячую перезагрузку** для **локальной** разработки pieces на вашей машине. 😎

<img src="/docs/resources/create-action.png" alt="">

- **🤖 AI-First**: Встроенные AI-pieces позволяют экспериментировать с разными провайдерами или создавать собственных агентов с помощью нашего AI SDK для построения flow прямо в конструкторе.

- **🏢 Готовность к enterprise**: Разработчики настраивают инструменты, а любой сотрудник организации может пользоваться no-code конструктором. Полная кастомизация — от брендинга до контроля.

- **🔒 Безопасность по умолчанию**: Self-hosted и изоляция от сети для максимальной безопасности и контроля над вашими данными.

- **🧠 Human in the Loop**: Откладывайте выполнение на определённое время или требуйте подтверждения. Это всего лишь pieces, построенные поверх фреймворка pieces, и вы можете создавать множество подобных. 🎨

- **💻 Интерфейсы пользовательского ввода**: Встроенная поддержка триггеров пользовательского ввода, таких как «Chat Interface» 💬 и «Form Interface» 📝
...
- [x] HTTP
- [x] Код с **NPM**
- [x] ASK AI в Code Piece (нетехнический пользователь может очищать данные, не умея писать код)
- [x] Полное версионирование flow
- [x] Переводы на разные языки
- [x] Настраиваемые шаблоны
- [X] 200+ Pieces, смотрите https://www.activepieces.com/pieces

**Мы часто выпускаем обновления. Актуальные возможности смотрите в changelog продукта.**


## 🔌 Создайте собственный Piece

Activepieces поддерживает интеграции с Google Sheets, OpenAI, Discord, RSS и более чем 200 другими сервисами. [Посмотрите полный список поддерживаемых интеграций](https://www.activepieces.com/pieces), который постоянно расширяется благодаря вкладу нашего сообщества.

Как **открытая экосистема**, весь исходный код интеграций доступен в нашем репозитории. Эти интеграции версионируются и [публикуются](https://www.npmjs.com/search?q=%40activepieces) напрямую на npmjs.com после добавления.

Вы легко можете создать собственную интеграцию с помощью нашего TypeScript-фреймворка. Подробные инструкции смотрите в нашем [руководстве для контрибьюторов](https://www.activepieces.com/docs/build-pieces/building-pieces/overview).
...
Community Edition платформы Activepieces распространяется с открытым исходным кодом под [лицензией MIT](https://github.com/activepieces/activepieces/blob/main/LICENSE), а enterprise-функции — под [коммерческой лицензией](https://github.com/activepieces/activepieces/blob/main/packages/ee/LICENSE)


Подробнее о сравнении возможностей читайте здесь: https://www.activepieces.com/pricing
<br>
<br>
...
Мы приветствуем любой вклад — большой или маленький, в самых разных направлениях. Лучше всего начать с этого [документа](https://www.activepieces.com/docs/build-pieces/building-pieces/create-action), и мы всегда готовы пообщаться на [нашем сервере Discord](https://discord.gg/2jUXBKDdP8).

## 📚 Переводы

Не занимаетесь программированием, но хотите внести вклад? Присоединяйтесь к нашему [Discord](https://discord.gg/2jUXBKDdP8) и посетите https://www.activepieces.com/docs/about/i18n для получения дополнительной информации.
...
Приветствуется вклад любого рода!
