...
### - [x] V006 — Чекпоинт-валидация блока T029–T034
...
### - [x] T035 — Poll-триггеры звонков: incoming_call / outgoing_call
...
### - [x] V007 — Чекпоинт-валидация блока T035–T039 + финальный sweep фазы
